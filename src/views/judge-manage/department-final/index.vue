<template>
  <div class="content">
    ...
    <div class="department-btn">
        <el-button type="primary" @click="show()">测算结果</el-button>
    </div>
    <div class="department-table-two" v-if="Exhibition">
        <div class="title">当前各部门评价得分情况</div>
        <el-table :data="calculate" border style="width: 100%;" :row-style="{height:'45px'}">
            <el-table-column prop="department" label="部门"  align="center"></el-table-column>
            <el-table-column prop="currentScore" label="当前得分" width="220" align="center"></el-table-column>
            <el-table-column prop="excellentQuantity" label="优秀数量" width="220" align="center"></el-table-column>
            <el-table-column prop="goodQuantity" label="良好数量" width="220" align="center"></el-table-column>
            <el-table-column prop="qualifiedQuantity" label="合格数量" width="220" align="center"></el-table-column>
            <el-table-column prop="unqualifiedQuantity" label="不合格数量" width="220" align="center"></el-table-column>
            <el-table-column prop="deductionOfPoints" label="扣分合计" width="220" align="center"></el-table-column>
        </el-table>
    </div>
    <div class="department-btn">
...
<script>
import { showDataFinal, finalToSubmit, Calculation } from "@/api/manage/department";
export default {
  name: "JudgeDepartmentFinal",
  data() {
      return {
          evaluate: '',
          disabledFlag: false,
          currentDepartment: '综合管理部',
          Exhibition: false,
          subordinate: -1,
          selfAssessment: -1,
          tableData: [],
    ...
    methods:{
      ...
      show(){
        ...
        if(this.tableData.length == sum){
          Calculation(JSON.stringify(score)).then(response => {
            this.calculate = response.data.calculate
          });
      ...
      submit() {
        ...
        if(this.tableData.length == sum){
          finalToSubmit(JSON.stringify(score));
          this.$message({
            message: "评价完成",
            type: "success"
          });
